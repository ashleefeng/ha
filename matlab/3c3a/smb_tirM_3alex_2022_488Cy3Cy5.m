...
% last edited by X. Feng Sep 5, 2022 for 488 Cy3 Cy5
...
while i < NumberofPeaks
    ...
    plot( time, DonorCorrect_b, 'b' , time, AcceptorCorrect_b, 'r', 'LineWidth', 1.2);
    hold on
    plot(time, Donor2Correct_b,'color', [0 0.5 0], 'LineWidth', 1.2);
    hold off
    temp=axis;
