...
while i < NumberofPeaks
    ...
    plot(time_b, DonorCorrect_b, 'b', time_b, Donor2Correct_b, 'g', time_b, AcceptorCorrect_b, 'r', 'LineWidth', 1);
%     hold on
...
%     hold off
    ...
    plot(time_g, DonorCorrect_g, 'b', time_g, Donor2Correct_g, 'g', time_g, AcceptorCorrect_g, 'r', 'LineWidth', 1);
    temp=axis;
    ...
    plot(time_g, DonorCorrect_r, 'b', time_g, Donor2Correct_r, 'g', time_g, AcceptorCorrect_r, 'r', 'LineWidth', 1);
    temp=axis;
...
if ~isempty(DT1)
    ...
    DT1 = DT1';
    fname1=[newfolder  '/dwelltime1.dat'];
